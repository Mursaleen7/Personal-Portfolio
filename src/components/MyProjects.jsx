...
const MyProjects = () => {
  ...
  const briefcaseY = useTransform(scrollYProgress, [0, 1], [0, -30])
  ...
  return (
    <section id="projects" className="py-20 relative" ref={ref} style={{ backgroundColor: '#0e100f' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Floating Icon Element - Persistent Briefcase */}
        <motion.div
          className="fixed right-10 hidden lg:block z-30"
          style={{ 
            y: briefcaseY,
            top: 'calc(50% + 120px)'
          }}
          initial={{ opacity: 0, x: 50 }}
          animate={inView ? { opacity: 0.9, x: 0 } : { opacity: 0, x: 50 }}
        ...
        >
          ...
          >
            <Briefcase size={24} style={{ color: '#0e100f' }} />
          </motion.div>
        </motion.div>
