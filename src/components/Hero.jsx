...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative" ref={ref} style={{ backgroundColor: '#0e100f', paddingTop: '40px' }}>
        ...
        >
              ...
              <div className="flex justify-center relative">
                <div className="relative">
                  ...
                  <div className="absolute left-0 top-0 flex items-baseline">
                    ...
                    <span style={{ color: '#16f0d1' }}>DEVELOPER.</span>
                  </div>
                </div>
                {/* Role Annotation - Left of "& DEVELOPER", vertically centered */}
          ...
          <motion.div variants={itemVariants} className="mt-6 text-center max-w-5xl">
            <p className="text-lg md:text-xl lg:text-2xl font-headline font-normal leading-relaxed" style={{ color: '#F3F3F3' }}>
              ...
              <span className="font-semibold" style={{ color: '#a374ff' }}>vulnerability assessment</span> and{' '}
